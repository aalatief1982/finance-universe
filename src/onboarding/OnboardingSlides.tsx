...
const OnboardingSlides: React.FC<Props> = ({ onComplete }) => {
  ...
  return (
    <div className="relative w-full h-screen bg-gradient-to-br from-background via-background to-muted/30 overflow-hidden">
      ...
      {/* Progress indicator */}
      <div className="absolute top-safe z-10 left-1/2 transform -translate-x-1/2 pt-4">
      ...
      >
        {slides.map((slide, i) => (
          <SwiperSlide key={i}>
            <div className={`flex flex-col h-full transition-all duration-700 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
              {/* Header with icon and gradient */}
              <div className={`relative pt-16 pb-8 bg-gradient-to-b ${slide.gradient}`}>
                <div className="flex flex-col items-center text-center px-6">
                  <div className="mb-4 p-3 rounded-2xl bg-card/80 backdrop-blur-sm border border-border/50 shadow-lg">
                  ...
                  <p className="text-lg font-medium text-primary mb-2 animate-slide-up" style={{ animationDelay: '0.1s' }}>
                    {slide.subtitle}
                  </p>
              ...
              <div className="flex-1 flex items-center justify-center px-6 pb-6">
                <div className="relative w-full max-w-sm">
                  ...
                  <div className="relative bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl p-4 shadow-xl">
                    <img
