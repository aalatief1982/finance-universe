/**
 * @file BudgetDetailPage.tsx
 * @description Page component for BudgetDetailPage.
 *
 * @module pages/budget/BudgetDetailPage
 *
 * @responsibilities
...
const BudgetDetailPage = () => {
  ...
  const targetName = React.useMemo(() => {
    ...
    return target ? ('name' in target ? target.name : budget.targetId) : budget.targetId;
  }, [budget]);
