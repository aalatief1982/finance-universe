/**
 * @file VendorCategorization.tsx
 * @description Page component for VendorCategorization.
 *
 * @module pages/sms/VendorCategorization
 *
 * @responsibilities
...
const VendorCategorization: React.FC = () => {
  ...
  useEffect(() => {
    ...
    rawMessages.forEach((msg: { message?: string }) => {
