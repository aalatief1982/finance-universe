/**
 * @file ProcessSmsMessages.tsx
 * @description Page component for ProcessSmsMessages.
 *
 * @module pages/ProcessSmsMessages
 *
 * @responsibilities
...
const handleReadSms = async () => {
  ...
  return (
    ...
    <Layout>
      ...
      {messages.length > 0 && (
        <ToggleGroup type="single" value={filter} onValueChange={(val) => setFilter((val || 'all') as 'all' | 'matched' | 'skipped')} className="mb-4">
