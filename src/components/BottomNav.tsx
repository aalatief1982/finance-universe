...
const BottomNav: React.FC = () => {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-30 bg-background border-t border-border transform-gpu will-change-transform isolate [backface-visibility:hidden]">
